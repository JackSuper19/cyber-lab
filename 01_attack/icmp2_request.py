...
- Sorgente:     192.168.236.131
- Destinazione: 192.168.236.132
- Interfaccia:  eth0
...
# === Parametri ===========
SRC_IP  = "192.168.236.131"   # IP sorgente (richiede privilegi per impostarlo a mano)
DST_IP  = "192.168.236.132"   # IP destinazione
